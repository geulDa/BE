...
<p>
  ...
  <img src="https://img.shields.io/badge/Spring AI-6DB33F?style=flat&logo=spring&logoColor=white" />
...
| 파트 | ✧ FE                              | FE                                      | FE                                      |
| ---- | -------------------------------- | ---------------------------------------- | ---------------------------------------- |
| 이름 | [박규민](https://github.com/FrontHeadlock) | [이동준](https://github.com/dongjune8931) | [최민수](https://github.com/Neo1228) |


---

### ⚙️ 아키텍처 구조 or 기술 스택 추가 설명..등등
